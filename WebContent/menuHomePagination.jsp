<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%@page import="java.util.*,java.io.*,java.sql.Blob,com.nacre.ofo.dto.*" %>
         ...
         <div class="menu_block">
           <nav>
            <ul class="sf-menu">
                   ...
                   <li class="current"><a href="./MenuItemsControllerPagination">Menu</a></li>
  ...
  <div class="zerogrid">
  	...
  	<table width="100%">	 		
  		...
  		<c:if test="${(list1.itemId mod 2) eq 1}"> 
	        ...
	        <div class="col-1-2">
				<div class="wrap-col">
				<img src="images/img${list1.itemId}.png" width="209px" height="152px" alt="" class="img_inner">
			  	</div>
	        </div>
	        <div class="col-1-2">
				<div class="wrap-col">
				<form method='post' action='signin.jsp' onsubmit="return validateForm(${list1.itemId})" >
	          	 	<b><div style="font-size:20px;color:red; margin-bottom:13px;"><a href="#">${list1.itemName}</a></div></b>   
	          	  	...
	          	  	<div style="font-size:large;margin-bottom:10px;"> Item Status : ${list1.itemStatus}. </div>	          	   	
...
<div class="zerogrid">  
    ...
    <c:if test="${currentPage != 1}">
            <li><a href="MenuItemsControllerPagination?currentPage=${currentPage-1}">Previous</a>
            </li>
        </c:if>
        <c:forEach begin="1" end="${noOfPages}" var="i">
           <c:choose>
                ...
                <c:otherwise>
                    <li><a href="MenuItemsControllerPagination?currentPage=${i}">${i}</a>
                    </li>
                </c:otherwise>
            </c:choose>
        </c:forEach>
       <c:if test="${currentPage lt noOfPages}">
            <li><a href="MenuItemsControllerPagination?currentPage=${currentPage+1}">Next</a>
            </li>
        </c:if>         
    </ul>
	</nav></div>
