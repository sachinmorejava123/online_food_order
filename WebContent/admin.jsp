         ...
         <div class="menu_block">
           <nav>
            <ul class="sf-menu">
				   ...
				   <li style="padding-left:5px"> <a href="./NewAddedOrdersController"> <i class="fa fa-bell" style="font-size:22px;color:blue;text-shadow:white;"><sup style="font-size:18px; line-height: 0; vertical-align: 3px"><span class="num" id="count"/></sup></i></a></li> 
