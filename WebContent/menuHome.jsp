  		...
  		<c:if test="${(list1.itemId mod 2) eq 1}"> 
	        ...
	        <div class="col-1-2">
				<div class="wrap-col">
				  ...
				  <%-- <c:set var="varImage" value="${list1.itemsImage}"/>
				  <%
				  	img=(byte[])pageContext.getAttribute("varImage");
				  ...
				  <%--<% 
					...
					o.write(img);
					o.close();			
				 <img src="ItemsImageRetrievalController?image=${list1.itemsImage}" width="209px" height="152px" alt="" class="img_inner">%>	
				  --%>
