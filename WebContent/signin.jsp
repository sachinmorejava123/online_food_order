			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<% String ss=(String)request.getAttribute("error") ;
					if(ss==null)
						...
						out.print("<h3 style='color:red;text-align:center'>Your Username/Password is not correct.</h3>");	
					  
				%>
				<form id="myform" action="LoginController" method="post" >
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn" id="btnvalidate"  name="submit" >
								Sing In
							</button>
						</div>
					</div>
