         ...
         <div class="menu_block">
           <nav>
            <ul class="sf-menu">
                   ...
                   <li class="current"><a href="./ViewOrdersController">View Orders</a>
                   </li>
...
<div class="content">
  <div class="zerogrid">
  	...
  	<center>	<span style="color: red;font-size:18px;" > <b id="msg"></b></span></center>
  	 <table style="width: 100%">
  		...
  		<%if(i%2==1){ %>
	        ...
	        <div  style="font-size:large;padding-left:30px;margin-bottom:7px;"> 
	        	 Status of Orders : <select name="status" class="statusid" style="font-size:18px" id="${list1.orderId}">
    ...
    <c:if test="${currentPage != 1}">
            <li><a href="ViewOrdersController?currentPage=${currentPage-1}">Previous</a>
            </li>
        </c:if>
        <c:forEach begin="1" end="${noOfPages}" var="i">
           <c:choose>
                ...
                <c:otherwise>
                    <li><a href="ViewOrdersController?currentPage=${i}">${i}</a>
                    </li>
                </c:otherwise>
            </c:choose>
        </c:forEach>
       <c:if test="${currentPage lt noOfPages}">
            <li><a href="ViewOrdersController?currentPage=${currentPage+1}">Next</a>
            </li>
        </c:if>         
    </ul>
	</nav></div>
